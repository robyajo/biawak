...
Welcome to the **Biawak** project manual! This guide provides full context, setup instructions, database management rules, and API design guidelines for developers working on this project.
